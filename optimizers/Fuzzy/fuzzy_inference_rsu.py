...
class FuzzyRsuInference:
    ...
    def Inference(self, fuzzy_input=None, showResult=False, plot=False):
        ...
        outputVector = [output['RSU Probability'], output['GNB Probability'], output['Self Probability']]
        ...
        probVector = Vector_processing.percentage(outputVector)
        outputVector = np.zeros([4, ])
        outputVector[1:, ] += probVector
...
### TEST
#FuzzySystemTest = FuzzyRsuInference(1, 10)
